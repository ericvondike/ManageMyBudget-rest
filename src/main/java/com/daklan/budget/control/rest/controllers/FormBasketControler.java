...
public class FormBasketControler {
    ...
    @RequestMapping(value = "/basketform", params={"output"})
    public String displayBasket(final ShoppingListIn shoppingListIn, final Model model) {
        model.addAttribute("basket", shoppingListIn);
